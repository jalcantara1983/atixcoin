...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s atixcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  atixcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded atixcoin transaction") + "\n" +
              "  atixcoin-tx [options] -create [commands]   " + _("Create hex-encoded atixcoin transaction") + "\n" +
              "\n";
