...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/atixcoin-project/atixcoin>";
    const std::string URL_WEBSITE = "<https://atixcoin.org>";
